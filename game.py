...
def main():
    ...
    running = True  # Add a running flag to control the loop
    ...
    while running:
        ...
        # Draw the pygame surface only when needed
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                running = False  # Exit the loop on Escape key press

        clock.tick(FPS)  # Control the frame rate

    # Cleanup resources properly after the loop ends
    cap.release()
